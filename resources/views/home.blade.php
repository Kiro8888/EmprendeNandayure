    ...
    <link href="lib/lightbox/css/lightbox.min.css" rel="stylesheet">
        <style>
            ...
            .products-section .card {
                border: 2px solid #009A00; /* Borde verde */
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            <p class="fs-5 fw-bold text-primary" style="color: #009A00 !important;">Nuestros Emprendimientos</p>
            <h1 class="display-5 mb-5 subir-y-bajar">Servicios y Productos que Ofrecemos para Ti</h1>
        </div>
